                ...
                if score is None:
                    ...
                    try:
                        ...
                        if not hasattr(self, 'ai_scorer') or not self.ai_scorer:
                            ...
                            print(f"[UC1_DEBUG] Initialized AI scorer")
                        ...
                        print(f"[UC1_DEBUG] Skipping score storage due to AI failure - no fallback scores allowed")
                        score = None
                else:
        ...
        if score is None:
            ...
            try:
                ...
                if not hasattr(self, 'ai_scorer') or not self.ai_scorer:
                    from app.services.ai_scoring_engine import AIFreeTextScorer
                    self.ai_scorer = AIFreeTextScorer()  # No ai_router needed - uses IBM WatsonX directly
                    print(f"[UC2] SIMPLE SCORING: Initialized AI scorer")
                ...
                # Skip scoring instead of using hardcoded fallback as per user requirements
                print(f"[UC2] SIMPLE SCORING: Skipping score storage due to AI failure - no fallback scores allowed")
                return
